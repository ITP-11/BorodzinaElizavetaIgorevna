...
int main()
{
	...
	do
	{
		...
		switch(item)
		{
			case 1: {addProcess(process,&processQuantity,memory,mc,&op,&bp);system("cls");	} break;
			case 2: {delProcess(process,&processQuantity,memory,mc);system("cls");}break;
			case 3: {showProcesses(process,processQuantity);system("cls");}break;
			case 4: {system("cls");puts("PROGRAMM WAS FINISHED");puts("made by Borodzina Elizaveta ITP-11");}break;
